...
class AnalysisWorkflow:
    ...
    def single_analysis_workflow(self, state: AnalysisWorkflowState) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis_result": {"recent_writing": recent_writings[0] if recent_writings else None},
            "AIContent": str(response.content)
        }
    ...
    def learning_advice_workflow(self, state: AnalysisWorkflowState) -> Dict[str, Any]:
        ...
        writing_prompt = self.learning_tools.create_writing_prompt(practice_topics[0] if practice_topics else "creative writing")
        
        tools_used = ["get_top_weakness", "suggest_practice_topics", "create_writing_prompt"]
...
def general_response_node(state: AnalysisWorkflowState) -> Dict[str, Any]:
    ...
    response = llm.invoke(f"Please provide a helpful response to this question about writing: {question}")
